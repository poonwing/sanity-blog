...
function Post({post}:Props) {
  ...
  const onSubmit:SubmitHandler<IFormInput> = async(data)=>{    ////SubmitHandler is return type
    ...
    <main>
        ...
        <div className='mt-10'>
          <PortableText
            ...
            serializers={{
              ...
              li:({chlidren}:any)=>(
                <li className='ml-4 list-disc'>{chlidren}</li>
              ),
              link:({href,children}:any)=>(
                <a href={href} className='text-blue-500 hover:underline'>{children}</a>
              ),
              exampleUsage:({language,code}:any)=>(
      ...
      {submitted?(
        ...
        <label className='block mb-5'>
          ...
          <textarea className='shadow border rounded py-2 px-3 form-textarea mt-1 block w-full ring-yellow-500 outline-none focus:ring' 
        ...
        <div className='flex flex-col p-5'>
          ...
          {
            errors.comment && (
              <span className='text-red-500'>- TheComment Field is required</span>
            )
          }
          {
            errors.email && (
